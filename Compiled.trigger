...
Trigger("\x006Kings"){
Conditions:
	Bring("Current Player", "Zerg Drone", "Diplo", At least, 1);
...
Actions:
	Move Location("Current Player", "Zerg Drone", "Diplo", "Diplo 1");
	Remove Unit At Location("Current Player", "Zerg Drone", 1, "Diplo 1");
	...
	Set Deaths("Player 1", "Protoss Forge", Set to, 3);
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Protoss Gateway", exactly, 3);
	Deaths("Current Player", "Zerg Beacon", At most, 0);

Actions:
	Set Deaths("Current Player", "Protoss Gateway", Set to, 0);
	Preserve Trigger();
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Protoss Gateway", exactly, 4);
	Deaths("Current Player", "Protoss Nexus", at least, 1);
...
Actions:
	...
	Set Deaths("Current Player", "Zerg Beacon", Subtract, 2);
	Preserve Trigger();
...
Conditions:
	Switch("Start", not set);
	Bring("Player 9", "Protoss Photon Cannon", "Anywhere", At least, 1);

Actions:
	Move Location("Player 9", "Protoss Photon Cannon", "Anywhere", "County Loc Universal");
	Remove Unit At Location("Player 9", "Protoss Photon Cannon", 1, "County Loc Universal");
	Create Unit with Properties("Player 8", "Protoss Photon Cannon", 1, "Buildings Buffer 1", 2);
	Set Doodad State("Player 8", "Protoss Photon Cannon", "Buildings Buffer 1", enabled);
	Move Unit("Player 8", "Protoss Photon Cannon", 1, "Buildings Buffer 1", "County Loc Universal");
	Preserve Trigger();
	Comment("Set board");
}
...
Trigger("\x006Kings"){
Conditions:
	Bring("Current Player", "Zerg Queen", "Anywhere", At least, 1);

Actions:
	Move Location("Current Player", "Zerg Queen", "Anywhere", "County Loc Universal");
	Preserve Trigger();
...
Trigger("\x006Kings"){
Conditions:
	Bring("\x006Kings", "Zerg Queen", "County Loc Universal", At least, 1);
	Bring("Player 12", "Terran SCV", "County Loc Universal", At least, 1);

Actions:
	Remove Unit At Location("Current Player", "Zerg Queen", 1, "County Loc Universal");
	Remove Unit At Location("Player 12", "Terran SCV", 1, "County Loc Universal");
...
Actions:
	Move Location("Current Player", "Protoss Photon Cannon", "Anywhere", "County Loc Universal");
	Set Deaths("Current Player", "Flag", Add, 1);
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Flag", Exactly, 5);
	Bring("Current Player", "Protoss Photon Cannon", "County Loc Universal", Exactly, 1);
	Bring("Player 12", "Terran SCV", "County Loc Universal", At most, 0);
	Bring("Player 12", "Tom Kazansky (Wraith)", "County Loc Universal", At most, 0);
	Deaths("Current Player", "Mineral Field (Type 1)", At least, 2);
	Deaths("Current Player", "Protoss Gateway", At most, 1);
...
Actions:
	...
	Set Deaths("Current Player", "Mineral Field (Type 1)", Subtract, 2);
...
Conditions:
	Deaths("Current Player", "Flag", Exactly, 5);
	Bring("Current Player", "Protoss Photon Cannon", "County Loc Universal", Exactly, 1);
	Bring("Player 12", "Terran SCV", "County Loc Universal", Exactly, 1);
	Bring("Player 12", "Tom Kazansky (Wraith)", "County Loc Universal", At most, 0);
...
Conditions:
	Deaths("Current Player", "Flag", Exactly, 5);
	Bring("Current Player", "Protoss Photon Cannon", "County Loc Universal", Exactly, 1);
	Bring("Player 12", "Tom Kazansky (Wraith)", "County Loc Universal", Exactly, 1);
	Bring("Player 12", "Terran SCV", "County Loc Universal", At most, 0);
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Flag", Exactly, 8);
	Bring("Current Player", "Terran Missile Turret", "County Loc Universal", Exactly, 1);
	Bring("Player 12", "Terran SCV", "County Loc Universal", At most, 0);
	Bring("Player 12", "Tom Kazansky (Wraith)", "County Loc Universal", At most, 0);
	Deaths("Current Player", "Mineral Field (Type 1)", At least, 3);
	Deaths("Current Player", "Protoss Gateway", At most, 1);
...
Actions:
	...
	Set Deaths("Current Player", "Mineral Field (Type 1)", Subtract, 3);
...
Conditions:
	...
	Bring("Player 12", "Terran SCV", "County Loc Universal", Exactly, 1);
	Bring("Player 12", "Tom Kazansky (Wraith)", "County Loc Universal", Exactly, 0);
	Deaths("Current Player", "Scanner Sweep", at most, 0);
...
Conditions:
	...
	Bring("Current Player", "Protoss Cybernetics Core", "County Loc Universal", Exactly, 1);
	Bring("Player 12", "Tom Kazansky (Wraith)", "County Loc Universal", Exactly, 1);
	Bring("Player 12", "Terran SCV", "County Loc Universal", Exactly, 0);
	Deaths("Current Player", "Scanner Sweep", at most, 0);
...
Actions:
	Set Deaths("Current Player", "Protoss Unused type   2", Add, 1);
...
Conditions:
	Deaths("Current Player", "Flag", Exactly, 2);
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 7);
...
Conditions:
	...
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 7);
	Deaths("Current Player", "Protoss Unused type   1", Exactly, 3);
	Deaths("Current Player", "Mineral Field (Type 1)", At most, 4);
...
Conditions:
	...
	Deaths("Current Player", "Mineral Field (Type 1)", At least, 6);
	Deaths("Current Player", "Protoss Gateway", At most, 1);
...
Actions:
	...
	Create Unit("Current Player", "Terran Firebat", 1, "Buffer Zone");
	Set Deaths("Current Player", "Protoss Unused type   1", Subtract, 1);
	Set Deaths("Current Player", "Zerg Beacon", Add, 6);
	Set Deaths("Current Player", "Mineral Field (Type 1)", Subtract, 6);
	Preserve Trigger();
	Comment("Spawn militia based on counter");
}
...
Conditions:
	...
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 7);
	Deaths("Current Player", "Protoss Unused type   1", Exactly, 4);
	Deaths("Current Player", "Mineral Field (Type 1)", At most, 5);
...
Conditions:
	Deaths("Current Player", "Flag", Exactly, 2);
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 5);
...
Actions:
	Create Unit("Current Player", "Terran Firebat", 1, "Buffer Zone");
	Set Deaths("Current Player", "Protoss Unused type   1", Subtract, 10);
	Set Deaths("Current Player", "Zerg Beacon", Add, 1);
...
Conditions:
	...
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 5);
	Deaths("Current Player", "Protoss Unused type   1", Exactly, 10);
	Deaths("Current Player", "Mineral Field (Type 1)", At most, 0);
...
Conditions:
	Deaths("Current Player", "Flag", Exactly, 2);
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 5);
	Deaths("Current Player", "Protoss Unused type   1", Exactly, 20);
	Deaths("Current Player", "Mineral Field (Type 1)", At least, 3);
	Deaths("Current Player", "Protoss Gateway", At most, 1);
...
Conditions:
	Deaths("Current Player", "Flag", Exactly, 2);
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 5);
	Deaths("Current Player", "Protoss Unused type   1", Exactly, 30);
	Deaths("Current Player", "Mineral Field (Type 1)", At least, 5);
	Deaths("Current Player", "Protoss Gateway", At most, 1);
...
Conditions:
	Deaths("Current Player", "Flag", Exactly, 2);
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 5);
	Deaths("Current Player", "Protoss Unused type   1", Exactly, 40);
	Deaths("Current Player", "Mineral Field (Type 1)", At least, 7);
	Deaths("Current Player", "Protoss Gateway", At most, 1);
...
Actions:
	...
	Set Deaths("Current Player", "Protoss Unused type   1", Subtract, 10);
	Set Deaths("Current Player", "Zerg Beacon", Add, 7);
	Set Deaths("Current Player", "Mineral Field (Type 1)", Subtract, 7);
	Preserve Trigger();
	Comment("Spawn barracks based on counter");
}
...
Conditions:
	...
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 5);
	Deaths("Current Player", "Protoss Unused type   1", Exactly, 40);
	Deaths("Current Player", "Mineral Field (Type 1)", At most, 3);
...
Conditions:
	Deaths("Current Player", "Flag", Exactly, 2);
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 3);
	Deaths("Current Player", "Protoss Unused type   1", Exactly, 100);
	Deaths("Current Player", "Mineral Field (Type 1)", At least, 1);
	Deaths("Current Player", "Protoss Gateway", At most, 1);
...
Conditions:
	Deaths("Current Player", "Flag", Exactly, 2);
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 3);
	Deaths("Current Player", "Protoss Unused type   1", Exactly, 200);
	Deaths("Current Player", "Mineral Field (Type 1)", At least, 2);
	Deaths("Current Player", "Protoss Gateway", At most, 1);
...
Conditions:
	Deaths("Current Player", "Flag", Exactly, 2);
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 3);
	Deaths("Current Player", "Protoss Unused type   1", Exactly, 300);
	Deaths("Current Player", "Mineral Field (Type 1)", At least, 3);
	Deaths("Current Player", "Protoss Gateway", At most, 1);
...
Conditions:
	Deaths("Current Player", "Flag", Exactly, 2);
	Deaths("Current Player", "Protoss Unused type   2", Exactly, 3);
	Deaths("Current Player", "Protoss Unused type   1", Exactly, 400);
	Deaths("Current Player", "Mineral Field (Type 1)", At least, 4);
	Deaths("Current Player", "Protoss Gateway", At most, 1);
...
Actions:
	...
	Set Deaths("Current Player", "Protoss Unused type   2", Set to, 4);
	Set Deaths("Current Player", "Protoss Unused type   1", Set to, 0);
	Set Deaths("Current Player", "Zerg Beacon", Add, 4);
	Set Deaths("Current Player", "Mineral Field (Type 1)", Subtract, 4);
	Preserve Trigger();
	Comment("Spawn cavalry based on counter");
}
...
Actions:
	Set Deaths("Current Player", "Protoss Unused type   1", Subtract, 100);
	Preserve Trigger();
...
Conditions:
	Switch("Start", set);
	Bring("Current Player", "Zerg Overlord", "PLY1 Menu", Exactly, 0);
	Deaths("Current Player", "Flag", At least, 1);
	Deaths("Current Player", "Flag", At most, 59);

Actions:
	Move Unit("Current Player", "Zerg Overlord", 1, "Anywhere", "PLY1 Menu");
	Set Deaths("Current Player", "Flag", Set to, 60);
...
Conditions:
	Switch("Start", set);
	Bring("Current Player", "Zerg Overlord", "PLY1 Menu", Exactly, 0);
	Deaths("Current Player", "Flag", At least, 60);
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Flag", Exactly, 61);
...
Actions:
	...
	Set Deaths("Current Player", "Zerg Beacon", Subtract, 2);
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 2);
	Set Deaths("Current Player", "Flag", Subtract, 1);
...
Actions:
	...
	Set Deaths("Current Player", "Zerg Beacon", Subtract, 3);
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 3);
	Set Deaths("Current Player", "Flag", Subtract, 1);
...
Actions:
	...
	Set Deaths("Current Player", "Zerg Beacon", Subtract, 4);
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 4);
	Set Deaths("Current Player", "Flag", Subtract, 1);
...
Actions:
	...
	Set Deaths("Current Player", "Zerg Beacon", Subtract, 5);
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 5);
	Set Deaths("Current Player", "Flag", Subtract, 1);
...
Actions:
	Set Deaths("Current Player", "Flag", Set to, 62);
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Flag", Exactly, 62);
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Flag", Exactly, 63);
...
Actions:
	Set Deaths("Current Player", "Flag", Set to, 64);
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Flag", Exactly, 64);
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Flag", Exactly, 65);
...
Actions:
	...
	Set Deaths("Current Player", "Flag", Subtract, 1);
	Set Deaths("Current Player", "Zerg Beacon", Subtract, 6);
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 6);
...
Actions:
	...
	Set Deaths("Current Player", "Flag", Subtract, 1);
	Set Deaths("Current Player", "Zerg Beacon", Subtract, 8);
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 8);
...
Actions:
	...
	Set Deaths("Current Player", "Flag", Subtract, 1);
	Set Deaths("Current Player", "Zerg Beacon", Subtract, 10);
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 10);
...
Actions:
	Set Deaths("Current Player", "Flag", Set to, 66);
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Flag", Exactly, 66);
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Flag", Exactly, 67);
...
Actions:
	Set Deaths("Current Player", "Zerg Beacon", Set to, 0);
...
Conditions:
	Switch("Start", set);
	Deaths("Current Player", "Protoss Gateway", at most, 0);
...
Actions:
	...
	Set Deaths("Current Player", "Protoss Gateway", Set To, 1);
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 1);
	Preserve Trigger();
...
Conditions:
	Deaths("Current Player", "Bengalaas (Jungle)", At most, 0);
	Deaths("Current Player", "Protoss Gateway", at most, 0);
	Deaths("Current Player", "Mineral Chunk (Type 2)", exactly, 2);
	Switch("Start", set);
...
Conditions:
	Deaths("Current Player", "Bengalaas (Jungle)", At most, 0);
	Deaths("Current Player", "Protoss Gateway", at most, 0);
	Deaths("Current Player", "Mineral Chunk (Type 2)", exactly, 3);
	Switch("Start", set);
...
Conditions:
	Deaths("Current Player", "Bengalaas (Jungle)", At most, 0);
	Deaths("Current Player", "Protoss Gateway", at most, 0);
	Deaths("Current Player", "Mineral Chunk (Type 2)", exactly, 4);
	Switch("Start", set);
...
Conditions:
	Deaths("Current Player", "Bengalaas (Jungle)", At most, 0);
	Deaths("Current Player", "Protoss Gateway", at most, 0);
	Deaths("Current Player", "Mineral Chunk (Type 2)", exactly, 5);
	Switch("Start", set);
...
Conditions:
	Deaths("Current Player", "Bengalaas (Jungle)", At most, 0);
	Deaths("Current Player", "Protoss Gateway", at most, 0);
	Deaths("Current Player", "Mineral Chunk (Type 2)", exactly, 6);
	Switch("Start", set);
...
Conditions:
	Deaths("Current Player", "Bengalaas (Jungle)", At most, 0);
	Deaths("Current Player", "Protoss Gateway", at most, 0);
	Deaths("Current Player", "Mineral Chunk (Type 2)", exactly, 7);
	Switch("Start", set);
...
Conditions:
	Deaths("Current Player", "Bengalaas (Jungle)", At most, 0);
	Deaths("Current Player", "Protoss Gateway", at most, 0);
	Deaths("Current Player", "Mineral Chunk (Type 2)", exactly, 9);
	Switch("Start", set);
...
Conditions:
	Deaths("Current Player", "Bengalaas (Jungle)", At most, 0);
	Deaths("Current Player", "Protoss Gateway", at most, 0);
	Deaths("Current Player", "Mineral Chunk (Type 2)", exactly, 10);
	Switch("Start", set);
...
Conditions:
	...
	Bring("All Players", "Zerg Drone", "County Loc Universal", At most, 0);
	Bring("Current Player", "Protoss Cybernetics Core", "County Loc Universal", At most, 0);
...
Actions:
	...
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 2);
	Set Deaths("Current Player", "Mineral Chunk (Type 1)", Add, 2);
...
Actions:
	...
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 3);
	Set Deaths("Current Player", "Mineral Chunk (Type 1)", Add, 3);
	Set Deaths("Current Player", "Protoss Shield Battery", Add, 1);
	Set Deaths("Current Player", "Kakaru (Twilight)", Add, 1);
	Preserve Trigger();
...
Actions:
	...
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 5);
	Set Deaths("Current Player", "Mineral Chunk (Type 1)", Add, 5);
	Set Deaths("Current Player", "Protoss Shield Battery", Add, 1);
	Set Deaths("Current Player", "Kakaru (Twilight)", Add, 1);
	Preserve Trigger();
...
Actions:
	...
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 1);
	Set Deaths("Current Player", "Mineral Chunk (Type 1)", Add, 1);
...
Actions:
	...
	Set Deaths("Current Player", "Mineral Field (Type 1)", Add, 7);
	Set Deaths("Current Player", "Mineral Chunk (Type 1)", Add, 7);
	Set Deaths("Current Player", "Terran Armory", Add, 1);
	Set Deaths("Current Player", "Kakaru (Twilight)", Add, 1);
	Preserve Trigger();
...
Trigger("\x006Kings"){
Conditions:
	Deaths("Current Player", "Kakaru (Twilight)", Exactly, 3);
	Deaths("Current Player", "Data Disc", Exactly, 1);
